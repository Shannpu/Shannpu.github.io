...
const tools_list = [
  ...
  {name: "Qingxi", iconSrc: regexpImg, routerPath: "/tools/qingxi"},
...
<template>
  <div class="home">
    ...
    <main class="main">
      <a-card title="学习">
        <div class="list-wrap">
          <ItemBox v-for="item in studys_list" :data-source="item"></ItemBox>
        </div>
      </a-card>
      <a-card title="小工具">
        <div class="list-wrap">
          <ItemBox v-for="item in tools_list" :data-source="item"></ItemBox>
        </div>
      </a-card>
    </main>
  </div>
